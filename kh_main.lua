...
function KH_UI:CreateImageFrame(width, height, parent, anchor, x, y, level, texCoord, texture)
    ...
    frame.texture = frame:CreateTexture(nil, "BACKGROUND", nil, 0)
...
function KH_UI:calc_edge_position(self, value, mainFrame)
    ...
    edge:SetRotation(radian + math.rad(90))
end
...
function KH_UI:cre_segment_textures(ring_config, self, mainFrame)
    ...
    local t0 = self:CreateTexture(nil, "BACKGROUND", nil, 0)
    ...
    local t1 = self:CreateTexture(nil, "BACKGROUND", nil, 0)
    ...
    local t2 = self:CreateTexture(nil, "BACKGROUND", nil, 0)
    ...
    local t3 = self:CreateTexture(nil, "BACKGROUND", nil, 0)
...
function KH_UI:create_portrait(mainFrame)
    ...
    mainFrame.portrait.Texture = mainFrame.portrait:CreateTexture("$parent_Texture", "BACKGROUND", nil, 0)
    mainFrame.portrait.redTexture = mainFrame.portrait:CreateTexture("$parent_Texture", "BACKGROUND", nil, 0)
    ...
    mainFrame.portrait.levelFrame.texture = mainFrame.portrait.levelFrame:CreateTexture(nil, "BACKGROUND", nil, 0)
